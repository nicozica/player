<div class="player-item-ref">
	<a class="player-link" onclick="load('player_90s');return false;" href="">
		<div class="player-thumb">
			<img src="assets/images/img_item_90s.jpg" alt="90s" />
		</div>
		<h2>90s</h2>
		<ul>
			<?php
	...
	<div class="icon-players">
		...
		<ul>
			<li><a class="wmp" href="assets/streams/90s.asx">Windows Media Player</a></li>
			<li><a class="winamp" href="assets/streams/90s.pls">Winamp</a></li>
			<li><a class="itunes" href="assets/streams/90s.pls">iTunes</a></li>
			<li><a class="realplayer" href="assets/streams/90s.ram">Real Player</a></li>
		</ul>
	</div>
